...
class TestConfigVerification(unittest.TestCase):
    def test_valid_configuration(self):
        self.assertTrue(planner.verifyConfig("test/config_valid.yaml"))

    def test_invalid_regex(self):
        self.assertEqual(planner.verifyConfig("test/config_invalid_regex.yaml"),
            "Invalid pattern (regex): /[*.cram/")

    def test_invalid_avus(self):
        self.assertEqual(planner.verifyConfig("test/" \
